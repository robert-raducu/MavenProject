...
public class CssSelectorExample extends BaseTest {
	...
	public void cssSelectorExample2() {
		// wildcards
		// * --> contains (orice fel de secventa de caractere)
		...
		// ~ --> contains word (secventa de caractere despartita de spatii)
		//h3[class~='sc_title']
